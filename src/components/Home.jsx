        ...
        <div className="card-columns">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                - Organized project responsibilities and layout with SCRUM
                client, Trello, by assigning duties to team members for daily,
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                - Recruited and trained 15 campus managers across seven states
                to implement operational frameworks at their universities to
                purchase over $300,000 in textbooks.
              </p>
              <p className="card-text">
              ...
              <p className="card-text">
                - Worked with CTO and Operations team to create new
                functionality to our website and applications that benefited the
                inventory process and our network of nearly 200 reps.
              </p>
            </div>
          </div>
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                ...
                staff to grow total number of restaurants from eight to 40
                across nine states in two years.
              </p>
            </div>
          </div>
